...
<form id="form" action="/memberModifyPwdProc.do" method="post" onsubmit="return validateCheck()">
	<div class="double__check">
		<input type="password" name="pwd" id="pwd" maxlength="30" placeholder="비밀번호 " />
	</div>
	<div class="input__container">
		<input type="password" name="pwd_confirm" id="pwd" maxlength="30" placeholder="비밀번호 확인 " />
	</div>
