...
<form action="/memberJoinProc.do" method="post" onsubmit="return validateCheck()" id="form">
	이름 : <input type="text" name="name" id="name" maxlength="10" style="width: 400px; height: 44px; font-size: 25px"/>
	아이디 : <input type="text" name="id" id="id" maxlength="20" oninput="initCheckId()" style="width: 400px; height: 44px; font-size: 25px"/>
	<button type="button" onclick="checkId()">중복확인</button>
	비밀번호 : <input type="password" name="pwd" id="pwd" maxlength="30" style="width: 400px; height: 44px; font-size: 25px"/>
	비밀번호확인 : <input type="password" name="pwd_confirm" id="pwd_confirm" maxlength="30" style="width: 400px; height: 44px; font-size: 25px"/>
