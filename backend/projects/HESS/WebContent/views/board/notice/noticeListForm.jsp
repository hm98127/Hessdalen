...
$(function(){
	...
	$("ul.tabs li").click(function () {
		...
		if(activeTab == "tab1"){
			$("#" + activeTab).load("/noticeList.do");
		} else if(activeTab == "tab2"){
			$("#" + activeTab).load("/eventList.do");
		}
	});
});
</script>
...
<body>
	...
	<div id="login">
		<%
			if (id == null) {
		%>
		<span class="login__btn"><a href="/memberLogin.do">LOGIN</a></span> <span class="login__btn"><a href="/memberJoin.do">JOIN</a></span>
		<%
			} else {
		%>
		<span class="login__btn"><a href="/memberLogout.do">LOGOUT</a></span> <span class="login__btn"><a href="/memberPage.do">MEMBERPAGE</a></span>
		<%
			}
		%>
	</div>
	...
	<div class="category__click">
		...
		<!-- Service Title -->
		<div id="service">
			<div class="select__service" id="container">
				<ul class="service__menu tabs">
					<li class="service__notice active" rel="tab1">Notice</li>
					<li class="service__event" rel="tab2">Event</li>
				</ul>
