...
<body>
	...
	<div class="category__click">
		...
		<div id="write__container">
			...
			<div class="form__box">
				<form action="/noticeRegister.do" method="post" id="editorForm">
					<div class="input__name">Title</div>
					<input type="text" name="title" id="title__input" maxlength="100"
					...
					<input type="button" value="Insert" id="insert" onclick="checkData()">
				</form>
			</div>
		</div>
</body>
