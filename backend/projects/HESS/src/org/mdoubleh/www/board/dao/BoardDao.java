...
public class BoardDao {
	...
	public int getBoardCount() {
		...
		int count = 0;
		try {
			pstmt = con.prepareStatement("SELECT COUNT(*) FROM board WHERE 1 = 1");
	...
	public ArrayList<BoardVo> getBoardList(Paging paging) {
		...
		try {
			pstmt = con.prepareStatement(
					"SELECT b.db_sq, m.id, b.sj, b.cn, b.hit, b.dttm FROM board b INNER JOIN member m ON b.mb_sq = m.mb_sq WHERE 1 = 1 ORDER BY db_sq desc LIMIT ?, ?");
