...
public class RegisterEventBoardAction implements Action {
	@Override
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		if (id == null) {
			...
			session.setAttribute("callback", "/writeEventBoard.do");
		...
		forward.setPath("/listEventBoard.do?pn=1");
